...
export function UploadJucepaVinculo() {
    ...
    const handleSubmit = async () => {
        if (selectedFile) {
            ...
            try {
                ...
                const responsePromise = fetch('http://10.96.0.61:5000/uploadjucepavinculo', {
                    method: 'POST',
                    body: formData,
                    headers: {
    ...
    return (
        <>
            <Helmet title="Jucepa Vínculo" />
            <div className="flex justify-center items-start min-h-screen">
                <div className="w-full max-w-lg p-8 bg-white rounded-md shadow-md">
                    <h1 className="text-2xl text-slate-800 text-center mb-6">Upload base de dados - JUCEPA Vínculo</h1>
