...
export function SidebarProcurador({ open, setOpen }: { open: boolean; setOpen: (open: boolean) => void }) {
            ...
            <nav className="space-y-2 mt-4 flex flex-col">
                ...
                <div className="relative">
                    <button
                        ...
                        className={`flex items-center gap-2 p-2 w-full text-left rounded hover:bg-gray-300 ${location.pathname.startsWith("/procurador/pessoas") ? "font-bold text-indigo-700" : "text-gray-500"}`}
                    >
                    ...
                    {pessoasOpen && open && (
                        <div className="ml-6 space-y-1">
                            <Link
                                ...
                                className={`flex items-center gap-2 p-2 rounded hover:bg-gray-300 ${location.pathname === "/procurador/pessoas/cnpj" ? "font-bold text-indigo-700" : "text-gray-500"}`}
                            >
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-2 p-2 rounded hover:bg-gray-300 ${location.pathname === "/procurador/pessoas/cpf" ? "font-bold text-indigo-700" : "text-gray-500"}`}
                            >
